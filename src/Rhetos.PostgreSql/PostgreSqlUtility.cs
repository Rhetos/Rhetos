...
#pragma warning restore CA1031 // Do not catch general exception types
        ...
        /// <summary>
        /// Converts the identifier to lowercase, because Rhetos uses PostgreSQL identifies without quotes as a database coding convention.
        /// When generating database, Rhetos uses strict identifiers that do not require quoting.
        /// </summary>
        public string Identifier(string name)
        {
            ...
            return LimitIdentifierLength(name).ToLowerInvariant();
        }
        ...
        /// <remarks>
        /// This method is not applicable to the objects in database that are generated by Rhetos.
        /// When generating the database, Rhetos uses strict identifiers that do not require quoting.
        /// See <see cref="Identifier(string)"/> instead, for handling the generated objects.
        /// </remarks>
