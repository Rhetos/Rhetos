...
{
    public class MsConnectionTesting : IConnectionTesting
    {
        ...
        public MsConnectionTesting(ConnectionString connectionString, ISqlExecuter sqlExecuter)
        {
        ...
        public void ValidateDbConnection()
        {
            ...
            _sqlExecuter.ExecuteReader(
                // PersistenceTransactionOptions.UseDatabaseTransaction is disabled on dbupdate.
