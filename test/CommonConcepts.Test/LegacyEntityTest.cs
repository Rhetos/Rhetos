...
namespace CommonConcepts.Test
{
    ...
    public class LegacyEntityTest
    {
        ...
        static string ReportLegacy1(IUnitOfWorkScope scope, Common.DomRepository domRepository)
        {
            var loaded = domRepository.Test13.Legacy1.Query().Select(l1 => l1.Name);
            return string.Join(", ", loaded.OrderBy(x => x));
        }

        static string ReportLegacy2(IUnitOfWorkScope scope, Common.DomRepository domRepository)
        {
