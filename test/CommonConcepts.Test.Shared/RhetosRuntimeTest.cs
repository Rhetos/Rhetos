    ...
    public class RhetosRuntimeTest
    {
        ...
        public void RuntimeRegistrationsRegressionTest()
        {
            ...
            TestUtility.AssertAreEqualByLine(
                string.Join("\r\n", _expectedRegistrationsRuntime.Split("\r\n", StringSplitOptions.RemoveEmptyEntries | StringSplitOptions.TrimEntries)
                    .OrderBy(x => x)),
                string.Join("\r\n", registrations));
        }
        ...
        const string _expectedEntityFrameworkRegistrationsRuntime =
@"
Activator = Ef6InitializationConnectionString (ReflectionActivator), Services = [Rhetos.MsSqlEf6.CommonConcepts.Ef6InitializationConnectionString], Lifetime = Autofac.Core.Lifetime.RootScopeLifetime, Sharing = Shared, Ownership = OwnedByLifetimeScope, Pipeline = Autofac.Core.Pipeline.ResolvePipeline
...
";
        ...
        const string _expectedEntityFrameworkRegistrationsRuntime =
@"
Activator = EfCoreOrmUtility (ReflectionActivator), Services = [Rhetos.Dom.DefaultConcepts.IOrmUtility], Lifetime = Autofac.Core.Lifetime.RootScopeLifetime, Sharing = Shared, Ownership = OwnedByLifetimeScope, Pipeline = Autofac.Core.Pipeline.ResolvePipeline
Activator = EntityFrameworkContext (ReflectionActivator), Services = [Common.EntityFrameworkContext, Microsoft.EntityFrameworkCore.DbContext], Lifetime = Autofac.Core.Lifetime.CurrentScopeLifetime, Sharing = Shared, Ownership = OwnedByLifetimeScope, Pipeline = Autofac.Core.Pipeline.ResolvePipeline
";

#endif

        private static readonly string _expectedRegistrationsRuntime =
            _expectedEntityFrameworkRegistrationsRuntime +
$@"
Activator = ApplyFiltersOnClientRead (ProvidedInstanceActivator), Services = [Rhetos.Dom.DefaultConcepts.ApplyFiltersOnClientRead, AutoActivate], Lifetime = Autofac.Core.Lifetime.RootScopeLifetime, Sharing = Shared, Ownership = ExternallyOwned, Pipeline = Autofac.Core.Pipeline.ResolvePipeline
...
Activator = CommonConceptsRuntimeSqlResourcesPlugin (ReflectionActivator), Services = [Rhetos.SqlResources.ISqlResourcesPlugin], Lifetime = Autofac.Core.Lifetime.RootScopeLifetime, Sharing = Shared, Ownership = OwnedByLifetimeScope, Pipeline = Autofac.Core.Pipeline.ResolvePipeline
...
Activator = ConfigurationProvider (ProvidedInstanceActivator), Services = [Rhetos.Utilities.IConfiguration, AutoActivate], Lifetime = Autofac.Core.Lifetime.RootScopeLifetime, Sharing = Shared, Ownership = ExternallyOwned, Pipeline = Autofac.Core.Pipeline.ResolvePipeline
...
Activator = CurrentKeepSynchronizedMetadata (ProvidedInstanceActivator), Services = [Rhetos.Dom.DefaultConcepts.CurrentKeepSynchronizedMetadata, AutoActivate], Lifetime = Autofac.Core.Lifetime.RootScopeLifetime, Sharing = Shared, Ownership = ExternallyOwned, Pipeline = Autofac.Core.Pipeline.ResolvePipeline
...
Activator = DbProviderFactory (DelegateActivator), Services = [System.Data.Common.DbProviderFactory], Lifetime = Autofac.Core.Lifetime.RootScopeLifetime, Sharing = Shared, Ownership = OwnedByLifetimeScope, Pipeline = Autofac.Core.Pipeline.ResolvePipeline
...
Activator = RegisteredInterfaceImplementations (ProvidedInstanceActivator), Services = [Rhetos.Dom.DefaultConcepts.RegisteredInterfaceImplementations, AutoActivate], Lifetime = Autofac.Core.Lifetime.RootScopeLifetime, Sharing = Shared, Ownership = ExternallyOwned, Pipeline = Autofac.Core.Pipeline.ResolvePipeline
