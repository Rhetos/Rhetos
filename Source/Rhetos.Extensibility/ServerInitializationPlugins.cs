...
{
    public class ServerInitializationPlugins
    {
        private IEnumerable<IServerInitializer> _initializers;

        public ServerInitializationPlugins(IEnumerable<IServerInitializer> initializers)
        {
            this._initializers = initializers;
        }

        public IList<IServerInitializer> GetInitializers()
        {
