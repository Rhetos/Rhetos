...
Activator = DatabaseSettings (DelegateActivator), Services = [Rhetos.Persistence.DatabaseSettings], Lifetime = Autofac.Core.Lifetime.RootScopeLifetime, Sharing = Shared, Ownership = OwnedByLifetimeScope
