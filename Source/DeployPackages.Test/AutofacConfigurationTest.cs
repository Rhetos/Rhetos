...
Activator = DatabaseSettingsConstants (DelegateActivator), Services = [Rhetos.Persistence.IDatabaseSettings], Lifetime = Autofac.Core.Lifetime.RootScopeLifetime, Sharing = Shared, Ownership = OwnedByLifetimeScope
