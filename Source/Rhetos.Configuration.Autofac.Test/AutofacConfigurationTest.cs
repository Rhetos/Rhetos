...
Activator = DslSyntaxFromPlugins (ReflectionActivator), Services = [Rhetos.Dsl.IDslSyntax], Lifetime = Autofac.Core.Lifetime.RootScopeLifetime, Sharing = Shared, Ownership = OwnedByLifetimeScope
