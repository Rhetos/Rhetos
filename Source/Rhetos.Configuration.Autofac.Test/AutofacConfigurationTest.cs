...
Activator = DslGrammar (ReflectionActivator), Services = [Rhetos.Dsl.IDslGrammar], Lifetime = Autofac.Core.Lifetime.CurrentScopeLifetime, Sharing = None, Ownership = OwnedByLifetimeScope
