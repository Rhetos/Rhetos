...
Activator = DslGrammar (ReflectionActivator), Services = [Rhetos.Dsl.DslGrammar], Lifetime = Autofac.Core.Lifetime.CurrentScopeLifetime, Sharing = None, Ownership = OwnedByLifetimeScope
