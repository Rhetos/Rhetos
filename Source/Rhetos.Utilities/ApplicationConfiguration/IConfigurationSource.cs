...
{
    /// <summary>
    /// Each implementation source is responsible for normalizing configuration paths to predefined double underscore (__) separator.
    ...
    /// Paths and names ARE case sensitive.
    /// </summary>
