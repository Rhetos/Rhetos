...
namespace Rhetos.Deployment
{
    public class DataMigrationScripts
    {
        ...
        protected readonly RhetosAppOptions _rhetosAppOptions;
        protected readonly SqlTransactionBatches _sqlTransactionBatches;

        public DataMigrationScripts(ISqlExecuter sqlExecuter, ILogProvider logProvider, IDataMigrationScriptsProvider scriptsProvider, RhetosAppOptions rhetosAppOptions, SqlTransactionBatches sqlTransactionBatches)
        {
        ...
        public DataMigrationReport Execute()
        {
            ...
            if (skipped.Count > 0)
            {
                if (_rhetosAppOptions.DataMigration__SkipScriptsWithWrongOrder)
                {
