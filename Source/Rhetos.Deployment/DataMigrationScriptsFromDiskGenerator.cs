...
{
    public class DataMigrationScriptsFromDiskGenerator : IGenerator
    {
        ...
        public DataMigrationScriptsFromDiskGenerator(IInstalledPackages installedPackages,
        ...
        public void Generate()
        {
            ...
            File.WriteAllText(Path.Combine(_buildOptions.GeneratedAssetsFolder, DataMigrationScriptsFileName), serializedMigrationScripts, Encoding.UTF8);
