...
Activator = IDataStructureReadParameters (DelegateActivator), Services = [Rhetos.Dom.DefaultConcepts.IDataStructureReadParameters], Lifetime = Autofac.Core.Lifetime.CurrentScopeLifetime, Sharing = None, Ownership = OwnedByLifetimeScope, Pipeline = Autofac.Core.Pipeline.ResolvePipeline
