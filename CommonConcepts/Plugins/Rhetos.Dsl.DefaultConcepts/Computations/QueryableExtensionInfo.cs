...
namespace Rhetos.Dsl.DefaultConcepts
{
    ...
    public class QueryableExtensionInfo : DataStructureInfo, IMacroConcept
    {
        ...
        {
            // TODO (?) Copy all filters from base concept (it makes more sense for ComputedExtension beacuse of efficient implementation, not really necessary for QueryableExtension)
