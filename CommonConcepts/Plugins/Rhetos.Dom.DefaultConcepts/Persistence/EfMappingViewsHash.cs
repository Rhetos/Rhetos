...
namespace Rhetos.Dom.DefaultConcepts.Persistence
{
    class EfMappingViewsHash : IEfMappingViewsHash
    {
        ...
        public string GetAdditionalHash()
        {
            ...
            var ormProperties = _dslModel.Concepts // It is important to use the ordering of properties in "_dslModel.Concepts", since it the is how the C# properties are generated by CodeGenerator.
                .OfType<PropertyInfo>()
