        ...
        public void Generate()
        {
            ...
            else
            {
                ...
                var dbContext = (DbContext)_dom.GetType("Common.EntityFrameworkContext")
                    .GetConstructor(BindingFlags.NonPublic | BindingFlags.Instance, null, new[] { typeof(DbConnection), dbConfiguration.GetType(), typeof(RhetosAppOptions) }, null)
                    .Invoke(new object[] { connection, dbConfiguration, _rhetosAppOptions });
