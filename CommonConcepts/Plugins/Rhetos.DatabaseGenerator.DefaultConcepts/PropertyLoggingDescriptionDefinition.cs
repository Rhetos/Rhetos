...
namespace Rhetos.DatabaseGenerator.DefaultConcepts
{
    ...
    public class PropertyLoggingDescriptionDefinition : IConceptDatabaseDefinitionExtension
    {
        ...
        public void ExtendDatabaseStructure(IConceptInfo conceptInfo, ICodeBuilder codeBuilder, out IEnumerable<Tuple<IConceptInfo, IConceptInfo>> createdDependencies)
        {
            ...
            codeBuilder.InsertCode(
                Sql.Format("EntityLoggingDefinition_CommonLogDescriptionProperty",
                    column,
                    propertyToString),
                EntityLoggingDescriptionDefinition.CommonLogDescriptionPropertyTag, info.EntityLogging);

            createdDependencies = new[] { Tuple.Create<IConceptInfo, IConceptInfo>(info.Property, info.EntityLogging) }; // Entity's property (table column) must be created before entity's logging view is created.
        }
