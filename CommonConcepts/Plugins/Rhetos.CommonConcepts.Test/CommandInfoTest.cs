...
namespace Rhetos.CommonConcepts.Test
{
    ...
    public class CommandInfoTest
    {
        ...
        public void TestSummary()
        {
            ...
            Assert.AreEqual("DummyCommandInfo", new DummyCommandInfo { }.Summary());

            Assert.AreEqual("DownloadReportCommandInfo", new DownloadReportCommandInfo { }.Summary());
            Assert.AreEqual("DownloadReportCommandInfo Rhetos.CommonConcepts.Test.SimpleParameter", new DownloadReportCommandInfo { Report = simpleParameter }.Summary());
            Assert.AreEqual("DownloadReportCommandInfo Rhetos.CommonConcepts.Test.SimpleParameter as pdf", new DownloadReportCommandInfo { Report = simpleParameter, ConvertFormat = "pdf" }.Summary());

            Assert.AreEqual("ExecuteActionCommandInfo", new ExecuteActionCommandInfo { }.Summary());
            Assert.AreEqual("ExecuteActionCommandInfo Rhetos.CommonConcepts.Test.SimpleParameter", new ExecuteActionCommandInfo { Action = simpleParameter }.Summary());

            Assert.AreEqual("LoadDslModelCommandInfo", new LoadDslModelCommandInfo { }.Summary());
            Assert.AreEqual("PingCommandInfo", new PingCommandInfo { }.Summary());

            Assert.AreEqual("ReadCommandInfo ", new ReadCommandInfo { }.Summary());
            Assert.AreEqual("ReadCommandInfo Mod.Ent", new ReadCommandInfo { DataSource = "Mod.Ent" }.Summary());
            ...
            Assert.AreEqual("SaveEntityCommandInfo ", new SaveEntityCommandInfo { }.Summary());
