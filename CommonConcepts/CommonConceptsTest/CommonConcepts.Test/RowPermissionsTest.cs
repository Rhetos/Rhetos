        ...
        public void OptimizeExtension()
        {
            using (var container = new RhetosTestContainer())
            {
                ...
                Assert.AreEqual(
                    ...
                    TestRowPermissions.Repositories.OptimizeBase_Repository.GetRowPermissionsReadExpression(null, repository, context).ToString());
                Assert.AreEqual(
                    @"optimizeExtensionItem => optimizeExtensionItem.NameE.Contains(""allow"")",
                    TestRowPermissions.Repositories.OptimizeExtension_Repository.GetRowPermissionsReadExpression(null, repository, context).ToString());
