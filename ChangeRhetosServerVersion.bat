@IF [%1] == [] ECHO COMPOSITE VERSION NUMBER SHOULD BE GIVEN AS AN ARGUMENT OF THIS BATCH FILE. FOR EXAMPLE: ChangeRhetosServerVersion.bat 2.0.15 & EXIT /b 1
@IF NOT [%2] == [] ECHO COMPOSITE VERSION NUMBER SHOULD BE GIVEN AS AN ARGUMENT OF THIS BATCH FILE. FOR EXAMPLE: ChangeRhetosServerVersion.bat 2.0.15 & EXIT /b 1
