...
IF NOT EXIST CommonConcepts\CommonConcepts.TestApp\rhetos-app.local.settings.json COPY Tools\Configuration\Template.rhetos-app.local.settings.json CommonConcepts\CommonConcepts.TestApp\rhetos-app.local.settings.json
